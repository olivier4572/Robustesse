...
/*global getCookie*/
//ResultatCarte.js
/*global calculCarteIEM*/
/*global calculCarteXbarre*/
//MainGen.js
...
function majCookie() {
    ...
    if (select !== null) {
        ...
        /*global setCookie*/
        setCookie("selectCarteMesure", valeurCookie, 365);
    }
    select = document.getElementById("selectSg");
    if (select !== null) {
        valeurCookie = select.innerHTML;
        /*global setCookie*/
        setCookie("selectCarteSg", valeurCookie, 365);
    }
    select = document.getElementById("selectIndividuSg");
    if (select !== null) {
        valeurCookie = select.innerHTML;
        /*global setCookie*/
        setCookie("selectCarteIndividuSg", valeurCookie, 365);
    }
}
function recupCookie() {
    ...
    /*global getCookie*/
    valeurCookie = getCookie("selectCarteMesure");
    if (valeurCookie === "") {
        valeurCookie = 1;
    }
    document.getElementById("selectMesure").innerHTML = valeurCookie;
    valeurCookie = getCookie("selectCarteSg");
    if (valeurCookie === "") {
        valeurCookie = 1;
    }
    document.getElementById("selectSg").innerHTML = valeurCookie;
    valeurCookie = getCookie("selectCarteIndividuSg");
    if (valeurCookie === "") {
        valeurCookie = 1;
    }
...
function recupLocalStorage() {
    ...
    for (boucle = 1; boucle <= nbLigne; boucle = boucle + 1) {
        valeur = localStorage.getItem("CarteIEMLigne" + boucle);
        if (valeur !== null) {
            erreur = 0;
    ...
    for (boucle = 1; boucle <= nbLigne; boucle = boucle + 1) {
        valeur = localStorage.getItem("CarteXbarreLigne" + boucle);
        if (valeur !== null) {
            erreursg = 0;
            valeurSplit = valeur.split(";");
